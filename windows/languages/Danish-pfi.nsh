...
#
# See 'Danish-mui.nsh' for the strings which modify standard NSIS MUI messages.
#
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_3      "Spandenes navne kan kun indholde bogstaverne a til z med små bogstaver, samt - og _"
