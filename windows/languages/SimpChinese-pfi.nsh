...
;!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "This wizard will guide you through the installation of POPFile.\r\n\r\nIt is recommended that you close all other applications before starting Setup.\r\n\r\n$_CLICK"

; Default NSIS message:

!insertmacro PFI_LANG_STRING PFI_LANG_WELCOME_INFO_TEXT    "这将会在你的计算机，安装 POPFile 。\r\n\r\n在开始安装之前，建议先关闭其他所有应用程序。这将允许“安装程序”更新指定的系统文件，而不需要重新启动你的计算机。\r\n\r\n$_CLICK"
