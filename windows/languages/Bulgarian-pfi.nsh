...
#
# See 'Bulgarian-mui.nsh' for the strings which modify standard NSIS MUI messages.
#
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_3      "Имената на кошовете може да съдържат само малки латински букви от a до z плюс знаците - и _"
