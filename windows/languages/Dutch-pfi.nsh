...
# Dutch-pfi.nsh
#
# This file contains additional "Dutch" text strings used by the Windows installer
# for POPFile (these strings are unique to POPFile).
#
# See 'Dutch-mui.nsh' for the strings which modify standard NSIS MUI messages.
#
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_3      "Baknamen kunnen alleen a t/m z (geen hoofdletters) en - en _ karakters bevatten"
