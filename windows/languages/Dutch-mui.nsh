...
#
# See 'Dutch-pfi.nsh' for the strings which are used on the custom pages.
#
...
"POPFile Gebruikers Interface"

#--------------------------------------------------------------------------
# End of 'Dutch-mui.nsh'
#--------------------------------------------------------------------------
