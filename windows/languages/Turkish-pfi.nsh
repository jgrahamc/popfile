...
# Turkish-pfi.nsh
#
# This file contains additional "Turkish" text strings used by the Windows installer
# for POPFile (these strings are unique to POPFile).
#
# See 'Turkish-mui.nsh' for the strings which modify standard NSIS MUI messages.
#
