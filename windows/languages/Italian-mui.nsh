...
# Italian-mui.nsh
#
# This file contains additional "Italian" text strings used by the Windows installer
# for POPFile (these strings are customised versions of strings provided by NSIS).
#
# See 'Italian-pfi.nsh' for the strings which are used on the custom pages.
#
...
"POPFile Porta dell'interfaccia utente web"

#--------------------------------------------------------------------------
# End of 'Italian-mui.nsh'
#--------------------------------------------------------------------------
