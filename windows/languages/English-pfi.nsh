...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_1         "${IO_NL}There is no need to add more buckets"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_2         "${IO_NL}You must define AT LEAST TWO buckets"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_3         "${IO_NL}At least one more bucket is required"
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_IO_MSG_4         "${IO_NL}Installer cannot create more than"
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBMAKERR_4       "Once POPFile has been installed you can use its 'User Interface'${MB_NL}${MB_NL}control panel to create the missing bucket(s)."
