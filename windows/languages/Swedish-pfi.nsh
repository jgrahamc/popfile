...
#
# See 'Swedish-mui.nsh' for the strings which modify standard NSIS MUI messages.
#
...
!insertmacro PFI_LANG_STRING PFI_LANG_CBP_MBNAMERR_3      "Hinkens namn kan bara innehålla bokstäverna a till z (små bokstäver) samt - och _"
