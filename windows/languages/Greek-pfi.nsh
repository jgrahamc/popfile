...
# Greek-pfi.nsh
#
# This file contains additional "Greek" text strings used by the Windows installer
# for POPFile (these strings are unique to POPFile).
#
# See 'Greek-mui.nsh' for the strings which modify standard NSIS MUI messages.
#
