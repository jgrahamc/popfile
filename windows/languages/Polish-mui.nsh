...
# Polish-mui.nsh
#
# This file contains additional "Polish" text strings used by the Windows installer
# for POPFile (these strings are customised versions of strings provided by NSIS).
#
# See 'Polish-pfi.nsh' for the strings which are used on the custom pages.
#
...
"Ten kreator pomo¿e Ci zainstalowaæ program POPFile.\r\n\r\nZalecamy, byœ zamkn¹³ wszystkie uruchomione programy zanim rozpoczniesz instalacjê.\r\n\r\n"
...
"POPFile Interface u¿ytkownika"

#--------------------------------------------------------------------------
# End of 'Polish-mui.nsh'
#--------------------------------------------------------------------------
